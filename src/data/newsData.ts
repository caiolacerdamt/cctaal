...
export const newsData: NewsItem[] = [
  {
    ...
    translations: {
      ...
      zh: {
        title: "巴西在中国大豆市场份额达到73.6%，创历史新高",
        category: "市场与战略",
        summary: "2025/26年巴西市场份额达到前所未有的水平，巩固了对美国的领先地位。",
        content: `
          <p class="lead text-xl md:text-2xl font-light text-gray-800 mb-8 font-serif italic border-l-4 border-[#7c522e] pl-6">
              "巴西作为中国首选供应商的地位在2026年重塑了全球农业综合企业的地缘政治。"
          </p>
          <p>
              在截至2026年1月的贸易周期中，巴西在中国大豆市场的份额达到了历史性的73.6%。中国海关（GACC）数据证实，进口总量超过1.11亿吨，巴西产品主导了亚洲加工商的偏好。
          </p>
          <h2>竞争力和物流</h2>
          <p>
          ...
          <p>
              与此同时，美国的份额回落至15%，为三十年来的最低水平，受到南美供应强劲和北京新的多元化方针的压力。
          </p>
        `
      }
    }
