                ...
                <div className="rounded-2xl overflow-hidden flex flex-col lg:flex-row shadow-2xl">
                    ...
                    <div className="lg:w-1/2 relative min-h-[400px]">
                        ...
                        <div className="absolute bottom-6 left-8 text-white">
                            <p className="font-bold text-lg">Tecnologia & Campo</p>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-1/2 p-10 lg:p-16 flex flex-col justify-center bg-gradient-to-br from-[#1a1a1a] to-[#2d1b12] relative text-white">
                        ...
                        <p className="text-gray-300 text-lg font-light mb-8 leading-relaxed">
                            Conecte-se com a elite do setor agroindustrial. Inteligência de mercado, networking estratégico e oportunidades de negócios.
                        </p>
                        ...
                        <div className="space-y-4 mb-10">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-gray-200">Relatórios exclusivos de mercado</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="bg-[#7c522e] rounded-full p-1">
                                    <CheckCircle2 size={14} className="text-white" />
                                </div>
                                <span className="text-gray-200">Eventos e Missões Internacionais</span>
                            </div>
                        </div>
